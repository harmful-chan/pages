---
layout: post
title: "PPTP客户端使用（Ubuntu 16.04）"
platform: "Ubuntu 16.04"
author: "harmful-chan"
date: "2020-04-05 17:10"
tags: 
  - pptp
---
## 获得VPN账号
...
## ubuntu客户端界面配置
![](https://img2020.cnblogs.com/blog/1561523/202004/1561523-20200405151231383-455126671.png)
...
```ruby
$ sudo pptpsetup --create myvpn --server xxx.xxx.xxx.xxx --username xx1--password xx2--encrypt --start    # 启动vpn通道
...
$ sudo vi /etc/ppp/chap-secrets    #生成用户名和密码
xx1 myvpn "xx2" *
```
### 5. 通过网站路由功能，测试VPN
...
## 参考
[张丹(Conan)](http://blog.fens.me/vpn-pptp-client-ubuntu/)
