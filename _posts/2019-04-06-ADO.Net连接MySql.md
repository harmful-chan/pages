...
MySqlConnection conn=new MySqlConnection(connStr);|.ConnectionString(连接数据库字符串), .State(连接状态Closed、Open两种)|.Open()(打开连接), .Close()(关闭连接)|  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYzNzkyNjI4NSw4NjQ0OTg3OTEsLTY5MT
kwNjgxXX0=
-->