...
![image-20200530180200879]({{ site.res_url }}/myblog/img/image-20200530180200879.png)
...
![image-20200530175940690]({{ site.res_url }}/myblog/img/image-20200530175940690.png)
...
![image-20200530182113235]({{ site.res_url }}/myblog/img/image-20200530182113235.png)
...
![image-20200530185100472]({{ site.res_url }}/myblog/img/image-20200530185100472.png)
...
![image-20200530191705995]({{ site.res_url }}/myblog/img/image-20200530191705995.png)
...
![running]({{ site.res_url }}/myblog/img/running.gif)

## 三、VSCode搭建远程调试环境

vscode上微软官网下载就行，然后我们需要两个插件VScode Remote就不说了，走[ssh协议参考](https://www.jianshu.com/p/0f2fb935a9a1)，[官方](https://code.visualstudio.com/docs?start=true)。然后C/C++语法提示和gdb debug。记得是安装再服务器上，小心选错。

![image-20200530194341225]({{ site.res_url }}/myblog/img/image-20200530194341225.png)
...
![image-20200530194717853]({{ site.res_url }}/myblog/img/image-20200530194717853.png)

![debug]({{ site.res_url }}/myblog/img/debug.gif)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ4OTU2OTk5Nyw3MDQ1MTgyMiwxNjkxND
Y0ODYsLTE0NzY1NjI1MTcsMTM1MDEzODMzNywtMTA4MzM0NDQ4
Myw5MzAzMjAyNjddfQ==
-->